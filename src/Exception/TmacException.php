...
';
    ...
    public function getError()
    {
        ...
        if ( env( 'app_debug' ) ) {
            ...
            die( sprintf( $this->html, $url, $index_url, urldecode( $this->getMessage() ), '请联系管理员', '' ) );
        }
    }
